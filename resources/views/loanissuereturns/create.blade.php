...
<div class="container">
    <div class="row">
        <div class="panel panel-default">
            <div class="panel-heading"><big>ITEMS RETURNING</big></div>
            <div class="panel-body">
                <form class="form-horizontal" role="form" method="POST" action="/loanissuereturns">
                        {{ csrf_field() }}

                        <div class="form-group">
                            <label class="col-md-4 control-label">loan account no</label>
                            <div class="col-md-2">
                                <select id="order_no"  class="form-control" ></select>
                                <input type="hidden" id="order_id" name="loanissue_id" value="" />
                            </div>
                        </div>
