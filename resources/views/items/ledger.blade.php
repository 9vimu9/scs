            ...
            <div class="panel-body">
                @if(count($logs)>0)
                    <?php
                        ...
                        $no_col_header="";
                    ?>
                    <table id="log" class="table table-bordered table-striped" width="75%">
                        <thead>
                          <tr>
                              <th  width="10%" rowspan="2" style="text-align: center" ><big>date</big></th>
                              <th colspan="4" style="text-align: center" ><big>RECEIPTS</big></th>
                              <th colspan="4"style="text-align: center"><big>ISSUES</big></th>
                              <th colspan="3"style="text-align: center"><big>STOCK</big></th>
                          </tr>
                            <tr>
